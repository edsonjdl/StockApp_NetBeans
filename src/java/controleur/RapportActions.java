 ...
 * @author edson
 */
public class RapportActions extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        infoRentabilite.afficherRentabilite();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RapportActions.class.getName()).log(Level.SEVERE, null, ex);
